...
In my paper, I describe a novel way to apply Federated Learning for voice-based accessibility software. This federated-learning-based solution allows models to be trained without exposing sensitive voice data to a central server. It also seeks to apply user-centered design principles to reduce the complexity of the federated learning process for end users. I describe the technical implementation of this solution and at the end of the paper, discuss the implications of this work for the future of disability software.
