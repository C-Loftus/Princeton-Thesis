...
The next source of user data is from user generated datasets. As spoken previously [talon](#talon) [client/scripts/parse_talon.py](client/scripts/parse_talon.py)
