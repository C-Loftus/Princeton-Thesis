...
# https://github.com/Lightning-AI/lightning-flash/blob/master/flash_examples/speech_recognition.py
...
download_data("https://pl-flash-data.s3.amazonaws.com/timit_data.zip", "../assets")
